...
public class ThirdFinishQuizActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_third_finish_quiz);
        Button back = (Button) findViewById(R.id.finish_previous);
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent toHomeActivity = new Intent(ThirdFinishQuizActivity.this,HomeActivity.class);
        ...
        restart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent toQuestionActivity = new Intent(ThirdFinishQuizActivity.this,ThirdQuestionActivity.class);
        ...
        review.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent toReviewActivity = new Intent(ThirdFinishQuizActivity.this,ThirdReviewQuestionActivity.class);
