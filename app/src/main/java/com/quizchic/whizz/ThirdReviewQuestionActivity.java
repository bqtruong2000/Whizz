...
public class ThirdReviewQuestionActivity extends AppCompatActivity implements View.OnClickListener {
    int questionIndex = 0;

    ArrayList<Question> questions = ThirdQuestionActivity.choosenQuestions;
    ...
    String[][] answersShuffled = ThirdQuestionActivity.answersShuffled;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_third_review_question);
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Restar", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Intent toThirdQuestionActivity = new Intent(ThirdReviewQuestionActivity.this,ThirdQuestionActivity.class);
//                        QuestionActivity.score = 0;
//                        QuestionActivity.questionIndex = 0;
                        startActivity(toThirdQuestionActivity);
                    }
                })
