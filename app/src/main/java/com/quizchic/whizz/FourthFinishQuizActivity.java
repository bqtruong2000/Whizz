...
public class FourthFinishQuizActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fourth_finish_quiz);
        Button back = (Button) findViewById(R.id.finish_previous);
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent toHomeActivity = new Intent(FourthFinishQuizActivity.this, HomeActivity.class);
        ...
        restart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent toQuestionActivity = new Intent(FourthFinishQuizActivity.this, FourthQuestionActivity.class);
        ...
        review.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent toReviewActivity = new Intent(FourthFinishQuizActivity.this, FourthReviewQuestionActivity.class);
