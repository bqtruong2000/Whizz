...
public class FourthReviewQuestionActivity extends AppCompatActivity implements View.OnClickListener {
    int questionIndex = 0;

    ArrayList<Question> questions = FourthQuestionActivity.choosenQuestions;
    ...
    String[][] answersShuffled = FourthQuestionActivity.answersShuffled;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fourth_review_question);
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Restar", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Intent toFourthQuestionActivity = new Intent(FourthReviewQuestionActivity.this,FourthQuestionActivity.class);
//                        QuestionActivity.score = 0;
//                        QuestionActivity.questionIndex = 0;
                        startActivity(toFourthQuestionActivity);
                    }
                })
