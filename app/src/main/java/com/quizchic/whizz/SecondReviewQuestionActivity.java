...
public class SecondReviewQuestionActivity extends AppCompatActivity implements View.OnClickListener {
    int questionIndex = 0;

    ArrayList<Question> questions = SecondQuestionActivity.choosenQuestions;
    ...
    String[][] answersShuffled = SecondQuestionActivity.answersShuffled;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_second_review_question);
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Restar", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Intent toSecondQuestionActivity = new Intent(SecondReviewQuestionActivity.this,SecondQuestionActivity.class);
